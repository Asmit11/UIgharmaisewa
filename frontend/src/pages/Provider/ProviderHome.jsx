      ...
      {showLocationAlert && (
        <div className="fixed top-4 right-4 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-md shadow-lg z-50">
          ...
          <button
            ...
            className="mt-2 bg-[#90D2B5] text-white py-1 px-3 rounded hover:bg-blue-600 transition duration-300"
          >
            Enable Location
          </button>
        </div>
      ...
      <div className="container mx-auto my-8 px-4">
        ...
        <div className="flex justify-between mt-6">
          ...
          <button
            ...
            className="bg-[#A3E5F0] hover:bg-blue-600 text-black px-4 py-2 rounded-2xl transition duration-300"
          >
            Next
          </button>
        </div>
